    ...
    <div className="bg-background py-12 md:py-16">
      <div className="container max-w-3xl mx-auto px-4">
        <header className="mb-10">
          ...
          <p className="text-muted-foreground">Spotlight Puerto Rico</p>
          <p className="text-sm text-muted-foreground">Effective Date: January 1, 2026</p>
        </header>

        <article className="prose prose-slate max-w-none prose-headings:font-display prose-headings:font-bold prose-a:text-primary prose-h2:mt-10 prose-h2:mb-3 prose-h3:mt-6">
          <h2>Important Notice Regarding Text Messaging Data</h2>
          <p>
            Spotlight Puerto Rico ("we," "us," or "our") DOES NOT share customer opt-in
            information, including phone numbers and consent records, with any affiliates
            or third parties for marketing, promotional, or any other purposes unrelated
            to providing our direct services. All text messaging originator opt-in data is
          ...
          <p>
            <strong>Text Message Program Terms &amp; Conditions.</strong> By opting into
            our SMS messaging services, you agree to receive text messages related to our
            services, including appointment reminders, customer support, and important
            updates.
          </p>
          ...
          <ul>
            <li>
              ...
              <a href="mailto:realspotlightpr@gmail.com">realspotlightpr@gmail.com</a>
            </li>
          ...
          <p>
            ...
            information and consent records.
          </p>

          <h2>4. Information Sharing &amp; Disclosure</h2>
          <p>
            We do not sell, rent, or trade personal information. We may share information
            with:
          </p>
          ...
          <p>
            ...
            electronic storage is 100% secure. We strive to use commercially acceptable
            means to protect your personal information but cannot guarantee absolute
            security.
          </p>
          ...
          <p>
            You may control cookies through your browser settings. Disabling cookies may
          ...
          <p>
            ...
            for their privacy practices and encourage you to review their policies. This
            privacy policy applies only to information collected by Spotlight Puerto Rico.
          </p>

          <h2>9. Changes to This Privacy Policy</h2>
          <p>
            We may update this policy periodically. The latest version will always be
            available on our website with the effective date. For significant changes, we
          ...
          <p>
            <strong>Spotlight Puerto Rico</strong>
            <br />
            Phone: +1 (833) 854-0770
            <br />
            Email: <a href="mailto:realspotlightpr@gmail.com">realspotlightpr@gmail.com</a>
            <br />
            Website: <a href="https://spotlightpuertorico.com">https://spotlightpuertorico.com</a>
          </p>
